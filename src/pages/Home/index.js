...
const Page = () => {
  // on declare les  variables 'data' et 'error' en utilisant le hook 'useData'
  // eslint-disable-next-line no-undef
  const { last,error } = useData(); // Avant  : const { last } = useData();

  // console.log("Value Data")
  // console.log(data)

  // on verfie  si 'data'et 'data.events'exsistent et s'il y a au moins un élément dans 'data.events'
  // Si c'est le cas, la variable 'last' est placé en dernier élément dans 'data.events'
